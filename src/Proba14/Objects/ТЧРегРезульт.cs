...
namespace IIS.Proba14
{
    ...
    public class ТЧРегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba14.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba14.РегРезульт fРегРезульт;
        ...
        public virtual IIS.Proba14.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba14.ИтогСобес result = this.fИтогСобес;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba14.РегРезульт.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегРезульт"})]
        public virtual IIS.Proba14.РегРезульт РегРезульт
        {
            get
            {
                ...
                IIS.Proba14.РегРезульт result = this.fРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегРезультE", typeof(IIS.Proba14.ТЧРегРезульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегРезульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba14.DetailArrayOfТЧРегРезульт members)

        // *** End programmer edit section *** (IIS.Proba14.DetailArrayOfТЧРегРезульт members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегРезульт(IIS.Proba14.РегРезульт fРегРезульт) : 
                base(typeof(ТЧРегРезульт), ((ICSSoft.STORMNET.DataObject)(fРегРезульт)))
        {
        }
        
        public IIS.Proba14.ТЧРегРезульт this[int index]
        {
            get
            {
                return ((IIS.Proba14.ТЧРегРезульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba14.ТЧРегРезульт dataobject)
        {
