...
namespace IIS.Proba14
{
    ...
    [View("ОрганизацияE", new string[] {
            "Наименование as \'Наименование организации\'",
            "Адрес as \'Адрес\'",
            "ТелОрганиз as \'Телефон организации\'"})]
    ...
    public class Организация : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОрганизацияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОрганизацияE", typeof(IIS.Proba14.Организация));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОрганизацияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОрганизацияL", typeof(IIS.Proba14.Организация));
                }
            }
        }
    }
