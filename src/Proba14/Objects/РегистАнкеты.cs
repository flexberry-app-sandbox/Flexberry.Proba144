...
namespace IIS.Proba14
{
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba14.ВакантДолжн fВакантДолжн;
        ...
        [PropertyStorage(new string[] {
                "ВакантДолжн"})]
        [NotNull()]
        public virtual IIS.Proba14.ВакантДолжн ВакантДолжн
        {
            get
            {
                ...
                IIS.Proba14.ВакантДолжн result = this.fВакантДолжн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Proba14.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Proba14.РегистАнкеты));
                }
            }
        }
    }
